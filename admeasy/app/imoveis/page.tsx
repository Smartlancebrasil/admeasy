                    ...
                    <tr key={i.id} style={{ borderBottom: '0.5px solid #1c2128' }} className="hover:bg-[#161b22] transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            <div style={{ color: '#f4f4f3' }} className="font-medium text-sm">{i.titulo}</div>
                            <div style={{ color: '#8b8d98' }} className="text-xs">{[i.bairro, i.cidade, i.estado].filter(Boolean).join(' · ')}</div>
                          </div>
                        </div>
                      </td>
                      <td style={{ color: '#8b8d98' }} className="px-4 py-3 text-xs capitalize">{i.tipo}</td>
                      <td style={{ color: '#8b8d98' }} className="px-4 py-3 text-xs">
                        {[
                      ...
                      <td style={{ color: '#f4f4f3' }} className="px-4 py-3 font-medium text-sm">
