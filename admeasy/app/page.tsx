  ...
  return (
    ...
    >
      ...
      <header style={{ borderBottom: `1px solid ${COLORS.line}`, background: `${COLORS.bg}cc` }} className="sticky top-0 z-50 backdrop-blur">
        <div className="max-w-[2000px] mx-auto px-5 md:px-8 lg:px-10 xl:px-12 h-24 flex items-center justify-between">
      ...
      {/* Hero */}
      <section className="max-w-[2000px] mx-auto px-5 md:px-8 lg:px-10 xl:px-12 pt-8 md:pt-12 pb-10 grid grid-cols-1 md:grid-cols-[0.72fr_1.4fr] gap-12 items-start">
        <div>
      ...
      <div
        ...
        className="fixed bottom-0 left-0 right-0 z-50 px-5 md:px-8 lg:px-10 xl:px-12 py-2.5"
      >
      ...
      <section style={{ borderTop: `1px solid ${COLORS.line}`, borderBottom: `1px solid ${COLORS.line}`, background: COLORS.surfaceAlt }}>
        <div className="max-w-[2000px] mx-auto px-5 md:px-8 lg:px-10 xl:px-12 py-10 grid grid-cols-2 md:grid-cols-5 gap-6">
          {[
      ...
      <section id="modulos" className="max-w-[2000px] mx-auto px-5 md:px-8 lg:px-10 xl:px-12 py-16 md:py-20">
        <div id="recursos" />
      ...
      <section id="imobiliarias" style={{ background: COLORS.surfaceAlt, borderTop: `1px solid ${COLORS.line}`, borderBottom: `1px solid ${COLORS.line}` }} className="py-16 md:py-24">
        <div className="max-w-[2000px] mx-auto px-5 md:px-8 lg:px-10 xl:px-12 grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-12 items-start">
          <div>
      ...
      {/* Blog / dicas */}
      <section id="blog" className="max-w-[2000px] mx-auto px-5 md:px-8 lg:px-10 xl:px-12 py-16 md:py-20">
      ...
      <footer style={{ borderTop: `1px solid ${COLORS.line}` }} className="pt-10 pb-20">
        <div className="max-w-[2000px] mx-auto px-5 md:px-8 lg:px-10 xl:px-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
